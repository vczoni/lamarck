...
def select_parent(pop, n, rank_column):
    popsize = len(pop)
...
def select_parents_by_tournament(ranked_pop: pd.DataFrame,
    ...
    for _ in range(n_parents):
        ...
        parent = select_parent(ranked_pop.loc[valid_index], n_dispute, rank_column)
...
class Populator:
    ...
    def sexual(self,
        ...
        return pd.concat(offspring_list).reset_index(drop=True)
    ...
    def asexual(self,
        ...
        for _ in range(n_mutations):
            parent_creature = select_parent(ranked_pop, 1, rank_column)
